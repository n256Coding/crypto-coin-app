...
# def calculate_profit_loss(today_coin_price: float, forecasted_coin_price: float, investing_amount_in_currency: float):
#     crypto_coins_today = (1 / today_coin_price) * investing_amount_in_currency

#     amount_in_currency_after_trading = crypto_coins_today * forecasted_coin_price
...
#     return abs(profit_loss), indicator
